...
#define LS7A_HTMSI_EN       (LS7A1000 | LS7A1000_HTMSI_EN)
#define LS7A_INTEDGE        (LS7A1000 | LS7A1000_INTEDGE)
#define LS7A_INTCLR         (LS7A1000 | LS7A1000_INTCLR)
#define LS7A_ROUTE_ENTRY0   (LS7A1000 | LS7A1000_ROUTE_ENTRY0)
...
#define TRAMPOLINE  0xFFFFFFFFFFFFE000UL
#define TEST_SPACE  0xFFFFFFFFFFFFF000UL

#define MAXVA (1UL << (12 + 9 + 9 + 9 - 1))
#define TRAPFRAME (MAXVA - PGSIZE)

                //MAXVA 0x4000000000UL 
